...
class FeaExtra(object):
    ...
    def __init__(self, dataset='epinions', k=1, debug=False):
        filename = '/home/cegt/experiment-data/{}/{}-train-{}.edgelist'.format(dataset, dataset, k)
        if debug:
            filename = './test-1.edgelists'
...
class FeaMoreExtra(object):
    ...
    def features_part3(self, u, v, betweenness_centrality, closeness_centrality):
        ...
        return betweenness_u, betweenness_v, closeness_u, closeness_v
